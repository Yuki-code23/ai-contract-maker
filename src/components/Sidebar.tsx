                ...
                <div className="flex-1 overflow-y-auto space-y-6">
                    ...
                    <div>
                        <button
                            ...
                            className={`w-full text-left rounded-md p-2 transition-colors ${isCollapsed ? 'flex justify-center' : ''
                                } ${currentPage.startsWith('/billings')
                                    ? 'bg-blue-100 dark:bg-blue-900'
                                    : 'hover:bg-gray-200 dark:hover:bg-gray-700'
                                }`}
                        >
                            {isCollapsed ? (
                                ...
                                <h3 className={`text-sm ${currentPage.startsWith('/billings')
                                    ? 'font-bold text-blue-900 dark:text-blue-100'
                    ...
                    <div>
                        <button
                            ...
                            className={`w-full text-left rounded-md p-2 transition-colors ${isCollapsed ? 'flex justify-center' : ''
                                } ${currentPage.startsWith('/payments')
                                    ? 'bg-blue-100 dark:bg-blue-900'
                                    : 'hover:bg-gray-200 dark:hover:bg-gray-700'
                                }`}
                        >
